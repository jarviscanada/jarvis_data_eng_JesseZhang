...
public class TraderAccountController {
  ...
  @ApiResponses(value = {@ApiResponse(code = 404, message = "Unable to delete the user")})
  ...
  @ApiResponses(value = {
      @ApiResponse(code = 404, message = "traderId is not found"),
      @ApiResponse(code = 400, message = "unable to withdraw due to user input. (e.g. insufficient)")})
  @ResponseStatus(HttpStatus.OK)
  @ResponseBody
