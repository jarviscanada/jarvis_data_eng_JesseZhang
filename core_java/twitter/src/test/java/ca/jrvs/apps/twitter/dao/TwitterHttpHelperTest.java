...
public class TwitterHttpHelperTest extends TestCase {
  ...
  public void testHttpPost() throws URISyntaxException, IOException {
    ...
    HttpResponse response = httpHelper.httpPost(new URI(
        "https://api.twitter.com/1.1/statuses/update.json?status=test_for_v1.1_again_from_Junit"));
  ...
  public void testHttpGet() throws IOException, URISyntaxException {
    ...
    HttpResponse response2 = httpHelper.httpGet(
        new URI(
            "https://api.twitter.com/1.1/statuses/show.json?id=1050118621198921728&include_entities=false"));
